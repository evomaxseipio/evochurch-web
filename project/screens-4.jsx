    ...
    <div>
      <div className="row between" style={{ flexWrap: "wrap", gap: 16 }}>
        <div>
          ...
          <p className="muted" style={{ margin: 0 }}>Personaliza tu perfil, apariencia y preferencias del sistema.</p>
        </div>
        <div className="row">
          <button className="btn primary" onClick={() => toast?.("success", "Cambios guardados", "Tu perfil fue actualizado.")}>
